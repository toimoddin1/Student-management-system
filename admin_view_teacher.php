    ...
    <div class="content">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="table_td">
<?php echo "
                    <a class='btn btn-danger' onClick=\" javascript:return confirm('Are You sure to Delete this'); \" href='admin_view_teacher.php?teacher_id={$info['id']}'>
                        Delete
                    </a>";
                    ?>
                </td>
                ...
                <td class="table_td">
                    <?php
                    echo "
                    <a class='btn btn-warning' href='admin_update_teacher.php?teacher_id={$info['id']}'>Update</a>";
                    ?>
                </td>
